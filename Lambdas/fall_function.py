...
def getdata():
    try:
        # Fall : https://dalonline.dal.ca/PROD/fysktime.P_DisplaySchedule?s_term=202310&s_crn=&s_subj=CSCI&s_numb=&n=41&s_district=100
        r = requests.get("https://dalonline.dal.ca/PROD/fysktime.P_DisplaySchedule?s_term=202310&s_crn=&s_subj=CSCI&s_numb=&n=41&s_district=100", stream=True)
